...
public class CustomerController {
	...
	@PostMapping
	public CustomerModel signUpCustomer(@Valid @RequestBody CustomerModel customer) {
	...
	//for editing customer
	 ...
	 public CustomerModel editCustomer(@PathVariable Integer cid, @RequestBody CustomerModel customer)throws ResourceNotFoundException{
